...
(function() {
  ...
  var fontASubset = new FontFaceObserver('CooperHewittBoldSubset', {
    weight: 700
  });
  var fontBSubset = new FontFaceObserver('CooperHewittBoldItalicSubset', {
    style: 'italic',
    weight: 700
  });
  ...
  Promise.all([
    ...
    var fontA = new FontFaceObserver('CooperHewittBold', {
      weight: 700
    });
    var fontB = new FontFaceObserver('CooperHewittBoldItalic', {
      style: 'italic',
      weight: 700
    });
